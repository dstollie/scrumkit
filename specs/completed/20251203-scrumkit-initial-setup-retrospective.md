...
**FV1.1:** Next.js 16 Project Setup met Bun [DONE - FV1.1]
...
**FV1.2:** Shadcn/UI Integratie [DONE - FV1.2]
...
**FV1.3:** Database Setup met Vercel Postgres [DONE - FV1.3]
...
**FV1.4:** Real-time Infrastructuur met Liveblocks [DONE - FV1.4]
...
**FV1.5:** OpenAI Integratie [DONE - FV1.5]
...
**FV2.1:** Retrospective Sessie Aanmaken [DONE - FV2.1]
...
**FV2.2:** Input Toevoegen door Teamleden [DONE - FV2.2]
...
**FV2.3:** Real-time Synchronisatie met Liveblocks [DONE - FV2.3]
...
**FV2.4:** Voting Systeem [DONE - FV2.4]
...
**FV2.5:** Automatische Ordening op Votes [DONE - FV2.5]
...
**FV3.1:** Discussie Modus per Item [DONE - FV3.1]
...
**FV3.2:** Action Items Registratie [DONE - FV3.2]
...
**FV4.1:** Automatische Rapport Generatie [DONE - FV4.1]
...
**FV4.2:** Rapport Formaten [DONE - FV4.2]
...
**FV4.3:** AI Prompt Configuratie [DONE - FV4.3]
...
### TO1: Project Structuur [DONE - TO1]
...
### TO2: Database Schema (Drizzle + Vercel Postgres) [DONE - TO2]
...
### TO3: Liveblocks Room Structuur [DONE - TO3]
...
### TO4: API Route Structuur [DONE - TO4]
...
### TO5: Environment Variables [DONE - TO5]
